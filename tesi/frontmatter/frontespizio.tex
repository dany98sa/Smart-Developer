...
\vspace{4cm}
{\Huge \bfseries Progettazione ed Implementazione di un Smart Developer per la Generazione Automatica di Casi di Test} \\
\vspace{5cm}
...
\textbf{Daniele De Marco} \\
Matricola: 0512107915
\end{minipage}
